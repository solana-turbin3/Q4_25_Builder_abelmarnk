...
mod tests {
    ...
    fn transfer_sol() {
        ...
        let to_pubkey = Pubkey::from_str("EibqN1sJ8mRkYKvvSWjxDvPjvmnfkMQ2XsiR6jqg8uFq").unwrap();
/*
...
*/
    ...
    fn wallet_to_base58() {
        println!(
            "Input your private key as a JSON byte array (e.g.[12,34,...]):"
        );
        let stdin = io::stdin();
        let wallet = stdin
            .lock()
    ...
    fn submit(){
        ...
        let (authority, _ ) = Pubkey::find_program_address(&[b"collection", collection.as_ref()], &turbin3_prereq_program);
        let data = vec![77u8, 124, 82, 163, 21, 133, 181, 206];
